...
%============================================MYSECTION
\pdfbookmark[1]{Création du personnage}{creation-perso}
\mysection{Création du personnage}

\pdfbookmark[2]{Traits}{traits}
\mysubsection{Traits}
...
\pdfbookmark[2]{Bons Points}{bon-points}
...
\pdfbookmark[2]{Liens entre Bons Points et Traits}{liens-bp-traits}
...
\pdfbookmark[2]{Expérience}{experience}
...
\begin{minipage}[c][0.95\textheight][c]{\linewidth}
\pdfbookmark[2]{Objectif Personnel}{objectif personnel}
...
\pdfbookmark[2]{Personnalité et photo}{perso-photo}
...
%=================================================SECTION
\pdfbookmark[1]{Les règles}{regles}
\mysection{Les règles}

\pdfbookmark[2]{Faire des choses}{faire-des-choses}
...
\pdfbookmark[2]{Influence du Dé Fantôme (DF)}{influence-df}
...
\pdfbookmark[2]{Mouvement}{mouvement}
...
\pdfbookmark[2]{Séquence de jeu}{sequence-jeu}
...
\pdfbookmark[2]{Combat à distance}{combat-distance}
...
\pdfbookmark[2]{Mort, dommages, hôpital et maladie}{mort-etc}
...
\deuxcolonnesbottom{%col1
\begin{minipage}[c][0.95\textheight][c]{\linewidth}
\pdfbookmark[2]{Équipement}{equipement}
...
\pdfbookmark[1]{Notions de fantômologie}{fantomologie}
\mysection{Notions de fantômologie}

\pdfbookmark[2]{Ectoprésence}{ectopresence}
...
\deuxcolonnesbottom{%col1
\begin{minipage}[c][0.95\textheight][c]{\linewidth}
\pdfbookmark[2]{Objectif personnel}{objectif-perso}
\mysubsection{Objectif personnel}
...
\pdfbookmark[2]{Utilisation du canon à proton}{canon-protons}
...
\pdfbookmark[2]{Autres méthodes}{autres-methodes}
...
\pdfbookmark[2]{Pouvoir et Capacité}{pouvoir-capa}
...
\pdfbookmark[2]{Vraies mauvaises nouvelles}{mauvaise-nouvelles}
...
\pdfbookmark[2]{Exemples de fantômes}{exemples-fantomes}
