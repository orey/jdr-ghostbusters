...
\myindent Les fantômes ont tous des \textbf{Pouvoirs} montrant leurs capacités de manipulation de l'énergie psychokinétique.

\myindent Ces derniers sont notés comme les Talents et fonctionnent de la même manière : pour les utiliser, déterminer un FD et lancer le nombre de dés correspondant au Pouvoir, en incluant le DF. Si le jet rate, soyez créatif et amusant. Si le DF est tiré avec un échec, la situation doit tout de même favoriser un peu le fantôme.

\begin{center}
\begin{tabular}{clcl}
\textbf{1D} & \textbf{Pouvoir I} & \textbf{1D} & \textbf{Pouvoir II (plus puissant)} \\
